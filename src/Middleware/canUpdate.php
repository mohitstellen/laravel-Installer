...
namespace SonaliBhika\LaravelInstaller\Middleware;

use Closure;
use SonaliBhika\LaravelInstaller\Middleware\canInstall;

class canUpdate
{
    use \SonaliBhika\LaravelInstaller\Helpers\MigrationsHelper;
