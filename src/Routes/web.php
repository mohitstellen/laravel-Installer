...
Route::group(['namespace' => 'SonaliBhika\LaravelInstaller\Controllers','middleware' => ['web', 'install']], function() {
Route::get('error/{var}', [
    'uses' => 'WelcomeController@error'
 ]);
});

Route::group(['prefix' => 'install','as' => 'LaravelInstaller::','namespace' => 'SonaliBhika\LaravelInstaller\Controllers','middleware' => ['web', 'install']], function() {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update','as' => 'LaravelUpdater::','namespace' => 'SonaliBhika\LaravelInstaller\Controllers','middleware' => 'web'],function() {
